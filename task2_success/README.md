...
Предварительно открыв терминал на уровне с DockerFile

1) `docker build -t poco_template_server .` 

2) `docker run -p 8080:8080 -e LOG_LEVEL=debug poco_template_server`

3) Для теста зайти на `http://127.0.0.1:8080/swaggerUI`
## Endpoints
---
> Swagger
