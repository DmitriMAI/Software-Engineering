...
#include "../controller/task_get_all_handler_auth.h"
#include "../controller/tasks_add_all_handler_auth.h"
#include "../controller/tasks_update_handler_auth.h"
...
public:
    Poco::Net::HTTPRequestHandler* createRequestHandler(
        ...
        if (path == "/api/v1/task" && method == "POST") {
            return new TasksUpdateStatusHandler();
        }
        
        if (path == "/api/v1/tasks" && method == "POST") {
            return new TasksAddHandler();
        }
