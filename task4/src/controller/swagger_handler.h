...
info:
  ...
  description: REST API for managing users, goals and tasks with JWT authentication
  version: 1.0.0
...
paths:
  ...
  /api/v1/users/login:
    get:
      ...
      description: Looks up a user by their exact login string.
      ...
      responses:
        "200":
          description: Always returns 200. Check `status` field to distinguish found vs not found.
          content:
            application/json:
              schema:
                oneOf:
  ...
  /api/v1/tasks:
    get:
      ...
      description: Returns a list of all tasks stored in MongoDB.
    ...
    post:
      ...
      description: Creates and stores a new task in MongoDB.
      operationId: addTask
      tags: [Tasks]
      security:
        - bearerAuth: []
  ...
  /api/v1/task:
    post:
      ...
      description: Updates the status of an existing task by its MongoDB ObjectId.
              ...
              examples:
                success:
                  value:
                    message: "Success on saving user"
        "500":
          description: Failed to parse request body or task not found
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/MessageResponse"
    ...
    TaskUpdateRequest:
      ...
      properties:
        _id:
          ...
          example: "69e53a9e534447850212f89e"
        status:
          type: string
          example: "done"
      required: [_id, status]
