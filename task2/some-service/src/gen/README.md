...
Simple Hello API
- API version: 1.0.0
  - Build date: 2026-03-13T21:45:04.089099700+03:00[Europe/Moscow]
...
------------ | ------------- | ------------- | -------------
*GreetingsApi* | [**getHello**](docs/GreetingsApi.md#getHello) | **GET** /hello | Возвращает приветствие


## Documentation for Models

 - [Error](docs/Error.md)
 - [GetHello200Response](docs/GetHello200Response.md)
